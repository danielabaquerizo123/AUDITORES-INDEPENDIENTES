...
export function ContractsPage(){
 ...
 const auditors=useQuery({queryKey:['auditors','contract-selector'],queryFn:()=>auditorsApi.list(1,'')});
 const assign=useMutation({mutationFn:({id,auditorId}:{id:string;auditorId:string})=>contractsApi.assignAuditor(id,auditorId),onSuccess:async()=>{setAuditorTarget(null);setSelectedAuditor('');await cache.invalidateQueries({queryKey:['contracts']})}});
